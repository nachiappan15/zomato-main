...
const Delivery = () => {
    ...
    return (
        <>
        <div className = "my-3">
        <h1 className = "text-xl mb-1 font-medium text-gray-600 tracking-wide lg:text-3xl lg:text-gray-700 lg:mb-5">Inspiration for your first order</h1>
            <DeliveryCarousel className="mt-2"/>

        </div>
        <div className = "my-3">
        <h1 className = "text-xl mb-2 font-medium text-gray-600 tracking-wide lg:text-3xl lg:text-gray-700 lg:mb-5">Top brands in spotlight </h1>
            <BrandCarousel className="mt-2"/>

        </div>
        <div className = "my-3">
        <h1 className = "text-xl mb-2 font-medium text-gray-600 tracking-wide lg:text-3xl lg:text-gray-700 lg:mb-5">Restaurants</h1>
