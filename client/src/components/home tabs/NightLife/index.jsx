...
import ReusableMasterCarousel from '../../Home Components/ReusableMasterCarousel'
// component
// RestaurantCard
...
const NightLife = () => {
    ...
    return (
        <>
            ...
            <div className="my-5">
                <h1 className="text-xl mb-2 font-medium text-gray-600 tracking-wide lg:font-semibold lg:text-3xl lg:text-gray-700 lg:mb-5">Nightlife Restaurants in Mumbai</h1>
